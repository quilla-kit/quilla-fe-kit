...
- 564ada2: Documentation, from adopter feedback on 0.4.0 / 0.7.0.
...
- Updated dependencies [564ada2]
  - @quilla-fe-kit/api-client@0.4.1

## 0.7.0

### Minor Changes

- cd5e39c: **BREAKING:** `useQueryBase` now forwards TanStack's `AbortSignal` to the HTTP
...
- adb5b01: Consumer-owned request URLs for the mutation hooks.
